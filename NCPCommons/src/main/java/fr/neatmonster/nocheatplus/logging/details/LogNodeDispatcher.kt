 ...
 * @author dev1mc
 */
interface LogNodeDispatcher {
    // TODO: Name.
    open fun <C> dispatch(node: LogNode<C?>?, level: Level?, content: C?)
     ...
     * @param logger
     */
    open fun setInitLogger(logger: ContentLogger<String?>?)
     ...
     * @param maxQueueSize
     */
    open fun setMaxQueueSize(maxQueueSize: Int)
}