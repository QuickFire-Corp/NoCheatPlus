 ...
 * @author asofold
 */
interface ILogThrowable {
    open fun debug(streamID: StreamID?, t: Throwable?)
    open fun info(streamID: StreamID?, t: Throwable?)
    open fun warning(streamID: StreamID?, t: Throwable?)
    open fun severe(streamID: StreamID?, t: Throwable?)
    open fun log(streamID: StreamID?, level: Level?, t: Throwable?)
}