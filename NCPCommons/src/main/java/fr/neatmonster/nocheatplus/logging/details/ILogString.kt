 ...
 * @author asofold
 */
interface ILogString {
    open fun debug(streamID: StreamID?, message: String?)
    open fun info(streamID: StreamID?, message: String?)
    open fun warning(streamID: StreamID?, message: String?)
    open fun severe(streamID: StreamID?, message: String?)
    open fun log(streamID: StreamID?, level: Level?, message: String?)
}