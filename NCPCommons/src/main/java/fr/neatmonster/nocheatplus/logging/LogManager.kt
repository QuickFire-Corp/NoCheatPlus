 ...
 * @author dev1mc
 */
interface LogManager : ILogString, ILogThrowable {
    /**
     * A stream that skips all messages. It's not registered officially.
     *
     * @return
     */
    open fun getVoidStreamID(): StreamID?
     ...
     * @return
     */
    open fun getInitStreamID(): StreamID?
     ...
     * @return
     */
    open fun getDefaultPrefix(): String?
     ...
     * @return
     */
    open fun hasLogger(name: String?): Boolean
     ...
     * @return
     */
    open fun hasLogger(loggerID: LoggerID?): Boolean
     ...
     */
    open fun getLoggerID(name: String?): LoggerID?
     ...
     * @return
     */
    open fun hasStream(name: String?): Boolean
     ...
     * @return
     */
    open fun hasStream(streamID: StreamID?): Boolean
     ...
     * @return Returns the registered StreamID or null, if not registered.
     */
    open fun getStreamID(name: String?): StreamID?
}