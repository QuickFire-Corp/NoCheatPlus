 ...
 * @author asofold
 */
class AcceptDenyCounter : IResettableAcceptDenyCounter, ICounterWithParent {
    private var acceptCount = 0
    private var denyCount = 0
    private var parent: IAcceptDenyCounter? = null
    override fun setParentCounter(parent: IAcceptDenyCounter?): AcceptDenyCounter? {
        this.parent = parent
        return this
    }

    override fun getParentCounter(): IAcceptDenyCounter? {
        return parent
    }
    ...
    override fun getAcceptCount(): Int {
        return acceptCount
    }
    ...
    override fun getDenyCount(): Int {
        return denyCount
    }

    override fun resetCounter() {
        denyCount = 0
        acceptCount = denyCount
    }
}