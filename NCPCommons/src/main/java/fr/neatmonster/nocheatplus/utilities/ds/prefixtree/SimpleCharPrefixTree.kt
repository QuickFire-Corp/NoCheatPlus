 ...
 * @author mc_dev
 */
class SimpleCharPrefixTree : CharPrefixTree<SimpleCharNode?, SimpleCharLookupEntry?>(NodeFactory { SimpleCharNode() },
    LookupEntryFactory { node, insertion, depth, hasPrefix ->
        SimpleCharLookupEntry(
            node,
            insertion,
            depth,
            hasPrefix
    ...
    class SimpleCharLookupEntry(node: SimpleCharNode?, insertion: SimpleCharNode?, depth: Int, hasPrefix: Boolean) :
        CharLookupEntry<SimpleCharNode?>(node, insertion, depth, hasPrefix)
}