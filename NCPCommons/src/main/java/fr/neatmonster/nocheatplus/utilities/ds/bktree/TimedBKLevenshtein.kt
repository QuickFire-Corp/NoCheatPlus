...
open class TimedBKLevenshtein<N : TimedLevenNode<N?>?, L : BKModTree.LookupEntry<CharArray?, N?>?>(
    nodeFactory: NodeFactory<CharArray?, N?>?,
    resultFactory: LookupEntryFactory<CharArray?, N?, L?>?
) : BKLevenshtein<N?, L?>(nodeFactory, resultFactory) {
    open class TimedLevenNode<N : TimedLevenNode<N?>?> : LevenNode<N?> {
        @kotlin.jvm.JvmField
        var ts: Long
         ...
         * @param value
         */
        constructor(value: CharArray?) : super(value) {
            ts = System.currentTimeMillis()
        }

        constructor(value: CharArray?, ts: Long) : super(value) {
            this.ts = ts
        }
    }

    class SimpleTimedLevenNode : TimedLevenNode<SimpleTimedLevenNode?> {
        constructor(value: CharArray?) : super(value) {}
        constructor(value: CharArray?, ts: Long) : super(value, ts) {}
    }
}