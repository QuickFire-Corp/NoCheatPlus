...
class BlockCacheSpigotCB1_8_R2(world: World?) : BlockCache() {
    protected var world: net.minecraft.server.v1_8_R2.WorldServer? = null
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_8_R2.Block = net.minecraft.server.v1_8_R2.Block.getById(id)
        ...
        return doubleArrayOf(block.B(), block.D(), block.F(), block.C(), block.E(), block.G())
    }
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_8_R2.Entity =
                    iterator.next() as net.minecraft.server.v1_8_R2.Entity as? EntityBoat
