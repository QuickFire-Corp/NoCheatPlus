...
class BlockCacheCB2922(world: World?) : BlockCache() {
    protected var world: net.minecraft.server.v1_7_R1.WorldServer? = null
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_7_R1.Block = net.minecraft.server.v1_7_R1.Block.e(id) ?: return null
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_7_R1.Entity =
                    iterator.next() as net.minecraft.server.v1_7_R1.Entity as? EntityBoat
