...
class BlockCacheCB3026(world: World?) : BlockCache() {
    protected var world: net.minecraft.server.v1_7_R2.WorldServer? = null
    ...
    private val iBlockAccess: IBlockAccess = object : IBlockAccess() {
        ...
        @Override
        fun getType(x: Int, y: Int, z: Int): Block {
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_7_R2.Block = net.minecraft.server.v1_7_R2.Block.e(id) ?: return null
        ...
        return doubleArrayOf(block.x(), block.z(), block.B(), block.y(), block.A(), block.C())
    }
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            val mcEntity: net.minecraft.server.v1_7_R2.Entity = (entity as CraftEntity).getHandle()
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_7_R2.Entity =
                    iterator.next() as net.minecraft.server.v1_7_R2.Entity as? EntityBoat
