...
class MCAccessCB2645 : MCAccess {
    /**
     * Constructor to let it fail.
     */
    init {
        commandMap
        ReflectionUtil.checkMembers("net.minecraft.server.v1_5_R1.", arrayOf("Entity", "dead"))
        ReflectionUtil.checkMethodReturnTypesNoArgs(
            net.minecraft.server.v1_5_R1.Block::class.java,
            arrayOf("u", "v", "w", "x", "y", "z"),
