...
class BlockCacheCB2645(world: World?) : BlockCache() {
    ...
    private val iBlockAccess: IBlockAccess = object : IBlockAccess() {
        ...
        fun getTypeId(x: Int, y: Int, z: Int): Int {
            return this@BlockCacheCB2645.getType(x, y, z).getId()
        }
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_5_R1.Block = net.minecraft.server.v1_5_R1.Block.byId.get(id) ?: return null
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            val mcEntity: net.minecraft.server.v1_5_R1.Entity = (entity as CraftEntity).getHandle()
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_5_R1.Entity =
                    iterator.next() as net.minecraft.server.v1_5_R1.Entity as? EntityBoat
