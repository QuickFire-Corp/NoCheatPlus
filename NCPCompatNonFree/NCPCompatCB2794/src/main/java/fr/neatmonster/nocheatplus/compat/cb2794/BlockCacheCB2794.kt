...
class BlockCacheCB2794(world: World?) : BlockCache() {
    protected var world: World? = null
    protected var bukkitWorld: World? = null
    var iBlockAccess: IBlockAccess = object : IBlockAccess() {
        @SuppressWarnings("deprecation")
        @Override
        fun getTypeId(x: Int, y: Int, z: Int): Int {
            return this@BlockCacheCB2794.getType(x, y, z).getId()
        }
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_6_R1.Block = net.minecraft.server.v1_6_R1.Block.byId.get(id) ?: return null
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            val mcEntity: net.minecraft.server.v1_6_R1.Entity = (entity as CraftEntity).getHandle()
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_6_R1.Entity =
                    iterator.next() as net.minecraft.server.v1_6_R1.Entity as? EntityBoat
