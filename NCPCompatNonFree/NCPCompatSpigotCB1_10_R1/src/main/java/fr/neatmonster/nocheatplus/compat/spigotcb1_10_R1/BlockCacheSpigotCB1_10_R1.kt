...
class BlockCacheSpigotCB1_10_R1(world: World?) : BlockCache() {
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_10_R1.Block = net.minecraft.server.v1_10_R1.Block.getById(id)
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_10_R1.Entity =
                    iterator.next() as net.minecraft.server.v1_10_R1.Entity
