...
class MCAccessSpigotCB1_10_R1 : MCAccess {
    ...
    init {
        ...
        ReflectionUtil.checkMethodReturnTypesNoArgs(
            net.minecraft.server.v1_10_R1.EntityLiving::class.java,
            arrayOf("getHeadHeight"),
            Float::class.javaPrimitiveType
        )
        ReflectionUtil.checkMethodReturnTypesNoArgs(
            net.minecraft.server.v1_10_R1.EntityPlayer::class.java,
            arrayOf("getHealth"),
            Float::class.javaPrimitiveType
        )
        ReflectionUtil.checkMembers(
            net.minecraft.server.v1_10_R1.AxisAlignedBB::class.java, Double::class.javaPrimitiveType,
            "a", "b", "c", "d", "e", "f"
        )
        ReflectionUtil.checkMethodReturnTypesNoArgs(
        ...
        ReflectionUtil.checkMembers("net.minecraft.server.v1_10_R1.", arrayOf("Entity", "length", "width", "locY"))
        ReflectionUtil.checkMembers(
    ...
    fun getBlockCache(world: World?): BlockCache {
        return BlockCacheSpigotCB1_10_R1(world)
    }

    @Override
    fun getHeight(entity: Entity): Double {
        val mcEntity: net.minecraft.server.v1_10_R1.Entity = (entity as CraftEntity).getHandle()
