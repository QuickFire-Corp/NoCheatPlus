...
class MCAccessCB2545 : MCAccess {
    /**
     * Constructor to let it fail.
     */
    init {
        commandMap
        ReflectionUtil.checkMembers("net.minecraft.server.v1_4_6.", arrayOf("Entity", "dead"))
        ReflectionUtil.checkMethodReturnTypesNoArgs(
            net.minecraft.server.v1_4_6.Block::class.java,
            arrayOf("v", "w", "x", "y", "z", "A"),
