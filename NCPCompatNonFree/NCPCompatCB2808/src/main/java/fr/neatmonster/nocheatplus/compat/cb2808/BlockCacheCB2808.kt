...
class BlockCacheCB2808(world: World?) : BlockCache() {
    ...
    private val iBlockAccess: IBlockAccess = object : IBlockAccess() {
        ...
        fun getTypeId(x: Int, y: Int, z: Int): Int {
            return this@BlockCacheCB2808.getType(x, y, z).getId()
        }
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_6_R2.Block = net.minecraft.server.v1_6_R2.Block.byId.get(id) ?: return null
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            val mcEntity: net.minecraft.server.v1_6_R2.Entity = (entity as CraftEntity).getHandle()
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_6_R2.Entity =
                    iterator.next() as net.minecraft.server.v1_6_R2.Entity as? EntityBoat
