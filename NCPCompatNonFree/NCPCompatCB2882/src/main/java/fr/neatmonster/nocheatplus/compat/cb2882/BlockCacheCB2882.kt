...
class BlockCacheCB2882(world: World?) : BlockCache() {
    ...
    private val iBlockAccess: IBlockAccess = object : IBlockAccess() {
        ...
        fun getTypeId(x: Int, y: Int, z: Int): Int {
            return this@BlockCacheCB2882.getType(x, y, z).getId()
        }
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_6_R3.Block = net.minecraft.server.v1_6_R3.Block.byId.get(id) ?: return null
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_6_R3.Entity =
                    iterator.next() as net.minecraft.server.v1_6_R3.Entity as? EntityBoat
