...
class BlockCacheSpigotCB1_8_R1(world: World?) : BlockCache() {
    protected var world: net.minecraft.server.v1_8_R1.WorldServer? = null
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_8_R1.Block = net.minecraft.server.v1_8_R1.Block.getById(id)
            ?: // TODO: Convention for null bounds -> full ?
            return null
        val shape: DoubleArray = LegacyBlocks.getShape(this, mat, x, y, z, true)
        if (shape != null) return shape
        block.updateShape(world, BlockPosition(x, y, z))

        // minX, minY, minZ, maxX, maxY, maxZ
        return doubleArrayOf(block.z(), block.B(), block.D(), block.A(), block.C(), block.E())
    }
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            val mcEntity: net.minecraft.server.v1_8_R1.Entity = (entity as CraftEntity).getHandle()
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_8_R1.Entity =
                    iterator.next() as net.minecraft.server.v1_8_R1.Entity as? EntityBoat
