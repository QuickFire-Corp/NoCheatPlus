...
class BlockCacheCBDev(world: World?) : BlockCache() {
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_12_R1.Block = net.minecraft.server.v1_12_R1.Block.getById(id)
        ...
        @SuppressWarnings("deprecation") val bb: AxisAlignedBB = block.b(world.getType(pos), world, pos)
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_12_R1.Entity =
                    iterator.next() as net.minecraft.server.v1_12_R1.Entity
