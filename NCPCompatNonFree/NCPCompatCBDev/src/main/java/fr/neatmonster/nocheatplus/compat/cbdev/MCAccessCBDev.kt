...
class MCAccessCBDev : MCAccess {
    ...
    init {
        ...
        ReflectionUtil.checkMethodReturnTypesNoArgs(
            net.minecraft.server.v1_12_R1.EntityLiving::class.java,
            arrayOf("getHeadHeight"),
            Float::class.javaPrimitiveType
        )
        ReflectionUtil.checkMethodReturnTypesNoArgs(
            net.minecraft.server.v1_12_R1.EntityPlayer::class.java,
            arrayOf("getHealth"),
            Float::class.javaPrimitiveType
        )
        ReflectionUtil.checkMembers(
            net.minecraft.server.v1_12_R1.AxisAlignedBB::class.java, Double::class.javaPrimitiveType,
            "a", "b", "c", "d", "e", "f"
        )
        ReflectionUtil.checkMethodReturnTypesNoArgs(
        ...
        ReflectionUtil.checkMembers("net.minecraft.server.v1_12_R1.", arrayOf("Entity", "length", "width", "locY"))
        ReflectionUtil.checkMembers(
    ...
    fun getBlockCache(world: World?): BlockCache {
        return BlockCacheCBDev(world)
    }

    @Override
    fun getHeight(entity: Entity): Double {
        // (entity.getHeight() returns the length field, but we access nms anyway.)
        val mcEntity: net.minecraft.server.v1_12_R1.Entity = (entity as CraftEntity).getHandle()
