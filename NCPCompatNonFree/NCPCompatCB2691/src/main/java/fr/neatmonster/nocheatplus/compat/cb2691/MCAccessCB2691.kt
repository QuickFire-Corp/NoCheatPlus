...
class MCAccessCB2691 : MCAccess {
    /**
     * Constructor to let it fail.
     */
    init {
        commandMap
        ReflectionUtil.checkMembers("net.minecraft.server.v1_5_R2.", arrayOf("Entity", "dead"))
        ReflectionUtil.checkMethodReturnTypesNoArgs(
            net.minecraft.server.v1_5_R2.Block::class.java,
            arrayOf("u", "v", "w", "x", "y", "z"),
