...
class BlockCacheSpigotCB1_8_R3(world: World?) : BlockCache() {
    protected var world: net.minecraft.server.v1_8_R3.WorldServer? = null
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_8_R3.Block = net.minecraft.server.v1_8_R3.Block.getById(id)
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_8_R3.Entity =
                    iterator.next() as net.minecraft.server.v1_8_R3.Entity as? EntityBoat
