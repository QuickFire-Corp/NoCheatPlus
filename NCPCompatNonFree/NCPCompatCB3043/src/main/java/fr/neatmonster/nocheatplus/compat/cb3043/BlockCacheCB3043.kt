...
class BlockCacheCB3043(world: World?) : BlockCache() {
    protected var world: net.minecraft.server.v1_7_R3.WorldServer? = null
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_7_R3.Block = net.minecraft.server.v1_7_R3.Block.e(id) ?: return null
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            val mcEntity: net.minecraft.server.v1_7_R3.Entity = (entity as CraftEntity).getHandle()
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_7_R3.Entity =
                    iterator.next() as net.minecraft.server.v1_7_R3.Entity as? EntityBoat
