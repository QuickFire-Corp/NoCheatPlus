...
class BlockCacheCB2602(world: World?) : BlockCache() {
    ...
    private val iBlockAccess: IBlockAccess = object : IBlockAccess() {
        ...
        fun getTypeId(x: Int, y: Int, z: Int): Int {
            return this@BlockCacheCB2602.getType(x, y, z).getId()
        }
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        @SuppressWarnings("deprecation") val id: Int = getType(x, y, z).getId()
        val block: net.minecraft.server.v1_4_R1.Block = net.minecraft.server.v1_4_R1.Block.byId.get(id) ?: return null
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            val mcEntity: net.minecraft.server.v1_4_R1.Entity = (entity as CraftEntity).getHandle()
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_4_R1.Entity =
                    iterator.next() as net.minecraft.server.v1_4_R1.Entity as? EntityBoat
