...
class BlockCacheSpigotCB1_11_R1(world: World?) : BlockCache() {
    ...
    private val iBlockAccess: IBlockAccess = object : IBlockAccess() {
        @Override
        fun getBlockPower(pos: BlockPosition?, dir: EnumDirection?): Int {
        ...
        @Override
        fun getType(pos: BlockPosition?): IBlockData {
            // TODO: Can this be cached ?
            return world.getType(pos)
        }

        @Override
        fun isEmpty(pos: BlockPosition?): Boolean {
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_11_R1.Block = net.minecraft.server.v1_11_R1.Block.getById(id)
        ...
        @SuppressWarnings("deprecation") val bb: AxisAlignedBB = block.b(iBlockAccess.getType(pos), iBlockAccess, pos)
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_11_R1.Entity =
                    iterator.next() as net.minecraft.server.v1_11_R1.Entity
