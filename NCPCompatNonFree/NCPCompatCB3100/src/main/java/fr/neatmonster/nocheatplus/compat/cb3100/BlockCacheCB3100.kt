...
class BlockCacheCB3100(world: World?) : BlockCache() {
    protected var world: net.minecraft.server.v1_7_R4.WorldServer? = null
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_7_R4.Block = net.minecraft.server.v1_7_R4.Block.getById(id)
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            val mcEntity: net.minecraft.server.v1_7_R4.Entity = (entity as CraftEntity).getHandle()
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_7_R4.Entity =
                    iterator.next() as net.minecraft.server.v1_7_R4.Entity as? EntityBoat
