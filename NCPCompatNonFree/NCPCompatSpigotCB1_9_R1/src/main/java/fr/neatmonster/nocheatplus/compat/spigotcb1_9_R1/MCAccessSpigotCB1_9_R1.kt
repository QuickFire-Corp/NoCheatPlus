...
class MCAccessSpigotCB1_9_R1 : MCAccess {
    ...
    init {
        ...
        ReflectionUtil.checkMethodReturnTypesNoArgs(
            net.minecraft.server.v1_9_R1.EntityLiving::class.java,
            arrayOf("getHeadHeight"),
            Float::class.javaPrimitiveType
        )
        ReflectionUtil.checkMethodReturnTypesNoArgs(
            net.minecraft.server.v1_9_R1.EntityPlayer::class.java,
            arrayOf("getHealth"),
            Float::class.javaPrimitiveType
        )
        ReflectionUtil.checkMembers(
            net.minecraft.server.v1_9_R1.AxisAlignedBB::class.java, Double::class.javaPrimitiveType,
            "a", "b", "c", "d", "e", "f"
        )
        ReflectionUtil.checkMethodReturnTypesNoArgs(
        ...
        ReflectionUtil.checkMembers("net.minecraft.server.v1_9_R1.", arrayOf("Entity", "length", "width", "locY"))
        ReflectionUtil.checkMembers(
    ...
    val mCVersion: String
        get() =// 1.9-1.9.3 (1_9_R1)
            "1.9-1.9.3"

    @get:Override
    val serverVersionTag: String
        get() = "Spigot-CB-1.9_R1"
    ...
    fun getBlockCache(world: World?): BlockCache {
        return BlockCacheSpigotCB1_9_R1(world)
    }

    @Override
    fun getHeight(entity: Entity): Double {
        val mcEntity: net.minecraft.server.v1_9_R1.Entity = (entity as CraftEntity).getHandle()
