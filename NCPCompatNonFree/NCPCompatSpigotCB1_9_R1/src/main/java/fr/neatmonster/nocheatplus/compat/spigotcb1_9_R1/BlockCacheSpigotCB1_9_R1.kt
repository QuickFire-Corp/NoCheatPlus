...
class BlockCacheSpigotCB1_9_R1(world: World?) : BlockCache() {
    protected var world: net.minecraft.server.v1_9_R1.WorldServer? = null
    ...
    fun fetchBounds(x: Int, y: Int, z: Int): DoubleArray? {
        ...
        val block: net.minecraft.server.v1_9_R1.Block = net.minecraft.server.v1_9_R1.Block.getById(id)
        ...
        val bb: AxisAlignedBB = block.a(world.getType(pos), world, pos)
    ...
    fun standsOnEntity(
        ...
        try {
            ...
            while (iterator.hasNext()) {
                val other: net.minecraft.server.v1_9_R1.Entity = iterator.next() as net.minecraft.server.v1_9_R1.Entity
