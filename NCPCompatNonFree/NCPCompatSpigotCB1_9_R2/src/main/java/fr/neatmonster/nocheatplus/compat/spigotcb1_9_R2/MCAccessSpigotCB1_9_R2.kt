...
class MCAccessSpigotCB1_9_R2 : MCAccess {
    ...
    init {
        ...
        ReflectionUtil.checkMethodReturnTypesNoArgs(
            net.minecraft.server.v1_9_R2.EntityLiving::class.java,
            arrayOf("getHeadHeight"),
            Float::class.javaPrimitiveType
        )
        ReflectionUtil.checkMethodReturnTypesNoArgs(
            net.minecraft.server.v1_9_R2.EntityPlayer::class.java,
            arrayOf("getHealth"),
            Float::class.javaPrimitiveType
        )
        ReflectionUtil.checkMembers(
            net.minecraft.server.v1_9_R2.AxisAlignedBB::class.java, Double::class.javaPrimitiveType,
            "a", "b", "c", "d", "e", "f"
        )
        ReflectionUtil.checkMethodReturnTypesNoArgs(
        ...
        ReflectionUtil.checkMembers("net.minecraft.server.v1_9_R2.", arrayOf("Entity", "length", "width", "locY"))
        ReflectionUtil.checkMembers(
    ...
    fun getBlockCache(world: World?): BlockCache {
        return BlockCacheSpigotCB1_9_R2(world)
    }
