...
class EntityAccessLastPositionAndLook : IEntityAccessLastPositionAndLook {
    init {
        ReflectionUtil.checkMembers(
            net.minecraft.server.v1_9_R2.Entity::class.java, Double::class.javaPrimitiveType, arrayOf(
                "lastX", "lastY", "lastZ"
            )
        )
        ReflectionUtil.checkMembers(
            net.minecraft.server.v1_9_R2.Entity::class.java, Float::class.javaPrimitiveType, arrayOf(
                "lastYaw", "lastPitch"
            )
        )
    }
    ...
    fun getPositionAndLook(entity: Entity, location: ISetPositionWithLook) {
        ...
        val nmsEntity: net.minecraft.server.v1_9_R2.Entity = (entity as CraftEntity).getHandle()
