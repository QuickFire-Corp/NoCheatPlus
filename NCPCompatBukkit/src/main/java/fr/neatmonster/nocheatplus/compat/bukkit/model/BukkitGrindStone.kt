...
class BukkitGrindStone : BukkitShapeModel {
    override fun getShape(blockCache: BlockCache?, world: World, x: Int, y: Int, z: Int): DoubleArray? {
        val block = world.getBlockAt(x, y, z)
        val blockData = block.state.blockData
        if (blockData is Grindstone) {
            val grindstone = blockData
            val facing = grindstone.facing
            when (grindstone.attachedFace) {
                AttachedFace.CEILING -> return when (facing) {
                    BlockFace.NORTH, BlockFace.SOUTH -> doubleArrayOf(
                    ...
                    BlockFace.EAST, BlockFace.WEST -> doubleArrayOf(
                ...
                AttachedFace.FLOOR -> return when (facing) {
                    BlockFace.NORTH, BlockFace.SOUTH -> doubleArrayOf(
                        0.125, 0.0, 0.375, 0.25, 0.4375, 0.625,
                    ...
                    BlockFace.EAST, BlockFace.WEST -> doubleArrayOf(
                        0.375, 0.0, 0.125, 0.625, 0.4375, 0.25,
                ...
                AttachedFace.WALL -> when (facing) {
                    BlockFace.NORTH -> return doubleArrayOf(
                        0.125, 0.375, 0.4375, 0.25, 0.625, 1.0,
                    ...
                    BlockFace.SOUTH -> return doubleArrayOf(
                    ...
                    BlockFace.EAST -> return doubleArrayOf(
                        0.0, 0.375, 0.125, 0.5625, 0.625, 0.25,
                    ...
                    BlockFace.WEST -> return doubleArrayOf(
                        0.4375, 0.375, 0.125, 1.0, 0.625, 0.25,
    ...
    override fun getFakeData(blockCache: BlockCache?, world: World, x: Int, y: Int, z: Int): Int {
        return 0
    }
}