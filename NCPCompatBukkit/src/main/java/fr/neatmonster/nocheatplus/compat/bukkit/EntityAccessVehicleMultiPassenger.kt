...
class EntityAccessVehicleMultiPassenger : IEntityAccessVehicle {
    init {
        // TODO: List<Entity>
        if (getMethodNoArgs(Entity::class.java, "getPassengers", MutableList::class.java) == null) {
            throw RuntimeException("Not supported.")
        }
    }

    override fun getEntityPassengers(entity: Entity): List<Entity> {
        return entity.passengers
    }

    override fun addPassenger(entity: Entity, vehicle: Entity): Boolean {
