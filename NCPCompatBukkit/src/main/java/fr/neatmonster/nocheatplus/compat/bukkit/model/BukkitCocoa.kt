...
class BukkitCocoa : BukkitShapeModel {
    override fun getShape(
        ...
        if (Bridge1_13.hasBoundingBox()) {
            val bd = block.boundingBox
            return doubleArrayOf(bd.minX - x, bd.minY - y, bd.minZ - z, bd.maxX - x, bd.maxY - y, bd.maxZ - z)
        }
        val state = block.state
        val blockData = state.blockData
        if (blockData is Cocoa && blockData is Directional) {
            val face = (blockData as Directional).facing
            when (blockData.age) {
                0 -> when (face) {
                    BlockFace.NORTH -> return doubleArrayOf(0.375, 0.4375, 0.0, 0.625, 0.75, 0.315)
                    BlockFace.SOUTH -> return doubleArrayOf(0.375, 0.4375, 0.685, 0.625, 0.75, 1.0)
                    BlockFace.WEST -> return doubleArrayOf(0.0, 0.4375, 0.375, 0.315, 0.75, 0.625)
                    BlockFace.EAST -> return doubleArrayOf(0.685, 0.4375, 0.375, 1.0, 0.75, 0.625)
                    else -> {}
                }
                1 -> when (face) {
                    BlockFace.NORTH -> return doubleArrayOf(0.3125, 0.3125, 0.0, 0.6875, 0.75, 0.4375)
                    BlockFace.SOUTH -> return doubleArrayOf(0.3125, 0.3125, 0.5625, 0.6875, 0.75, 1.0)
                    BlockFace.WEST -> return doubleArrayOf(0.0, 0.3125, 0.3125, 0.4375, 0.75, 0.6875)
                    BlockFace.EAST -> return doubleArrayOf(0.5625, 0.3125, 0.3125, 1.0, 0.75, 0.6875)
                    else -> {}
                }
                2 -> when (face) {
                    BlockFace.NORTH -> return doubleArrayOf(0.25, 0.1875, 0.0, 0.75, 0.75, 0.5625)
                    BlockFace.SOUTH -> return doubleArrayOf(0.25, 0.1875, 0.4375, 0.75, 0.75, 1.0)
                    BlockFace.WEST -> return doubleArrayOf(0.0, 0.1875, 0.25, 0.5625, 0.75, 0.75)
                    BlockFace.EAST -> return doubleArrayOf(0.4375, 0.1875, 0.25, 1.0, 0.75, 0.75)
                    else -> {}
                }
            }
        }
