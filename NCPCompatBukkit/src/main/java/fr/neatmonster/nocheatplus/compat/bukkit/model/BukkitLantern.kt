...
class BukkitLantern : BukkitShapeModel {
    private val xz = 0.3125
    override fun getShape(
        ...
        if (blockData is Lantern) {
            if (blockData.isHanging) return doubleArrayOf(
                xz, 0.0625, xz, 1 - xz, 0.5, 1 - xz,
                0.375, 0.5, 0.375, 0.625, 0.625, 0.625
            )
        }
        return doubleArrayOf(
            xz, 0.0, xz, 1.0 - xz, 0.4375, 1.0 - xz,
