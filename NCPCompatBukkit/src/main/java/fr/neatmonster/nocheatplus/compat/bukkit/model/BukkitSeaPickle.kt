...
class BukkitSeaPickle : BukkitShapeModel {
    override fun getShape(
        ...
        if (blockData is SeaPickle) {
            when (blockData.pickles) {
                1 -> return doubleArrayOf(0.375, 0.0, 0.375, 0.625, 0.375, 0.625)
                2 -> return doubleArrayOf(0.1875, 0.0, 0.1875, 0.8125, 0.375, 0.8125)
                3 -> return doubleArrayOf(0.125, 0.0, 0.125, 0.875, 0.375, 0.875)
                4 -> return doubleArrayOf(0.125, 0.0, 0.125, 0.875, 0.4375, 0.875)
                else -> {}
            }
        }
