...
class BukkitBamboo : BukkitShapeModel {
    override fun getShape(
        ...
        var i = x * 3129871L xor z * 116129781L xor 0
        i = i * i * 42317861L + i * 11L
        i = i shr 16
        val xOffset = ((i and 15L) / 15.0f - 0.5) * 0.5
        val zOffset = ((i shr 8 and 15L) / 15.0f - 0.5) * 0.5
        return doubleArrayOf(0.40625 + xOffset, 0.0, 0.40625 + zOffset, 0.59375 + xOffset, 1.0, 0.59375 + zOffset)
    }
