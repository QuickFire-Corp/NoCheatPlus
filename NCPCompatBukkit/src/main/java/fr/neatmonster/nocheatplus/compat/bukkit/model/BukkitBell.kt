...
class BukkitBell : BukkitShapeModel {
    override fun getShape(
        ...
        if (blockData is Bell) {
            ...
            val face = b.facing
            when (b.attachment) {
                Attachment.CEILING -> return doubleArrayOf(0.25, 1 - 0.75, 0.25, 0.75, 1.0, 0.75)
                Attachment.DOUBLE_WALL -> when (face) {
                    BlockFace.NORTH, BlockFace.SOUTH -> return doubleArrayOf( // Bottom bell
                        0.25, 0.25, 0.25, 0.75, 0.375, 0.75,  // Body
                        0.3125, 0.375, 0.3125, 0.6875, 0.8125, 0.6875,  // Stick hold the bell
                        0.4375, 0.8125, 0.0, 0.5625, 0.9375, 1.0 //0.0, 0.8125, 0.4375, 1.0, 0.9375, 0.5625
                    )
                    BlockFace.WEST, BlockFace.EAST -> return doubleArrayOf( // Bottom bell
                        0.25, 0.25, 0.25, 0.75, 0.375, 0.75,  // Body
                        0.3125, 0.375, 0.3125, 0.6875, 0.8125, 0.6875,  // Stick hold the bell
                ...
                Attachment.FLOOR -> when (face) {
                    BlockFace.NORTH, BlockFace.SOUTH -> return doubleArrayOf(0.0, 0.0, 0.25, 1.0, 1.0, 0.75)
                    BlockFace.WEST, BlockFace.EAST -> return doubleArrayOf(0.25, 0.0, 0.0, 0.75, 1.0, 1.0)
                    else -> {}
                }
                Attachment.SINGLE_WALL -> when (face) {
                    BlockFace.NORTH -> return doubleArrayOf( // Bottom bell
                        0.25, 0.25, 0.25, 0.75, 0.375, 0.75,  // Body
                        0.3125, 0.375, 0.3125, 0.6875, 0.8125, 0.6875,  // Stick hold the bell
                        0.4375, 0.8125, 0.0, 0.5625, 0.9375, 0.8125
                    )
                    BlockFace.SOUTH -> return doubleArrayOf( // Bottom bell
                        0.25, 0.25, 0.25, 0.75, 0.375, 0.75,  // Body
                        0.3125, 0.375, 0.3125, 0.6875, 0.8125, 0.6875,  // Stick hold the bell
                        0.4375, 0.8125, 0.1875, 0.5625, 0.9375, 1.0
                    )
                    BlockFace.WEST -> return doubleArrayOf( // Bottom bell
                        0.25, 0.25, 0.25, 0.75, 0.375, 0.75,  // Body
                        0.3125, 0.375, 0.3125, 0.6875, 0.8125, 0.6875,  // Stick hold the bell
                        0.0, 0.8125, 0.4375, 0.8125, 0.9375, 0.5625
                    )
                    BlockFace.EAST -> return doubleArrayOf( // Bottom bell
                        0.25, 0.25, 0.25, 0.75, 0.375, 0.75,  // Body
                        0.3125, 0.375, 0.3125, 0.6875, 0.8125, 0.6875,  // Stick hold the bell
