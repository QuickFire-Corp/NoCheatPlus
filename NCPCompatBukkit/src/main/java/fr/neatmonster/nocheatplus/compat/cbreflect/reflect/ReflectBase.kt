...
class ReflectBase {
    ...
    @kotlin.jvm.JvmField
    var obcPackageName: String? = null
    @kotlin.jvm.JvmField
    var nmsPackageName: String? = null
    ...
    init {
        ...
        var name = clazz.getPackage().name
        obcPackageName =
            if (name == "org.bukkit.craftbukkit" || name.indexOf("org.") == 0 && name.indexOf(".bukkit.") != -1 && name.indexOf(
                    ".craftbukkit."
                ) != -1
            ) {
                name
        ...
        // nms
        clazz = ServerVersion.getNMSMinecraftServer().javaClass
        name = clazz.getPackage().name
        nmsPackageName =
            if (name == "net.minecraft.server" || name.indexOf("net.") == 0 && name.indexOf(".minecraft.") != -1 && name.indexOf(
                    ".server."
                ) != -1
            ) {
                if (name.contains("v1_")) name else "net.minecraft.world.entity"
            } else {
                null
            }
    }
