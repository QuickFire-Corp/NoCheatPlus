 ...
 * @author asofold
 */
class ReflectAxisAlignedBB(base: ReflectBase?) {
    val nmsClass: Class<*>
    val nms_minX: Field?
    val nms_minY: Field?
    val nms_minZ: Field?
    ...
    init {
        ...
        nms_minX = getField(nmsClass, "a", Double::class.javaPrimitiveType)
        nms_minY = getField(nmsClass, "b", Double::class.javaPrimitiveType)
        nms_minZ = getField(nmsClass, "c", Double::class.javaPrimitiveType)
        nms_maxX = getField(nmsClass, "d", Double::class.javaPrimitiveType)
        nms_maxY = getField(nmsClass, "e", Double::class.javaPrimitiveType)
        nms_maxZ = getField(nmsClass, "f", Double::class.javaPrimitiveType)
        validateNotNull(nms_minX, nms_minY, nms_minZ, nms_maxX, nms_maxY, nms_maxZ)
    }
     ...
     */
    fun fillInValues(aabb: Any?, arr: DoubleArray): DoubleArray {
        return try {
