...
class BukkitHopper : BukkitShapeModel {
    override fun getShape(blockCache: BlockCache?, world: World, x: Int, y: Int, z: Int): DoubleArray? {
        ...
        if (blockData is Directional) {
            ...
            when (face) {
                BlockFace.NORTH -> return doubleArrayOf( // Standing inside
                    0.0, 0.625, 0.0, 1.0, 0.6875, 1.0,  // Middle
                    0.25, 0.25, 0.25, 0.75, 0.625, 0.75,  // Bottom
                    0.375, 0.25, 0.0, 0.625, 0.5, 0.25,  // Top
                    0.0, 0.6875, 0.0, 1.0, 1.0, 1.0 // 4 sides of hopper (top)
                    //0.0, 0.6875, 0.0, 1.0, 1.0, 0.125,
                    //0.0, 0.6875, 0.875, 1.0, 1.0, 1.0,
                    //0.0, 0.6875, 0.0, 0.125, 1.0, 1.0,
                    //0.875, 0.6875, 0.0, 1.0, 1.0, 1.0,
                )
                BlockFace.SOUTH -> return doubleArrayOf( // Standing inside
                    0.0, 0.625, 0.0, 1.0, 0.6875, 1.0,  // Middle
                    0.25, 0.25, 0.25, 0.75, 0.625, 0.75,  // Bottom
                    0.375, 0.25, 0.75, 0.625, 0.5, 1.0,  // Top
                    0.0, 0.6875, 0.0, 1.0, 1.0, 1.0 // 4 sides of hopper (top)
                    //0.0, 0.6875, 0.0, 1.0, 1.0, 0.125,
                    //0.0, 0.6875, 0.875, 1.0, 1.0, 1.0,
                    //0.0, 0.6875, 0.0, 0.125, 1.0, 1.0,
                ...
                BlockFace.WEST -> return doubleArrayOf( // Standing inside
                    0.0, 0.625, 0.0, 1.0, 0.6875, 1.0,  // Middle
                    0.25, 0.25, 0.25, 0.75, 0.625, 0.75,  // Bottom
                    0.0, 0.25, 0.375, 0.25, 0.5, 0.625,  // Top
                    0.0, 0.6875, 0.0, 1.0, 1.0, 1.0 // 4 sides of hopper (top)
                    //0.0, 0.6875, 0.0, 1.0, 1.0, 0.125,
                    //0.0, 0.6875, 0.875, 1.0, 1.0, 1.0,
                    //0.0, 0.6875, 0.0, 0.125, 1.0, 1.0,
                ...
                BlockFace.EAST -> return doubleArrayOf( // Standing inside
                    0.0, 0.625, 0.0, 1.0, 0.6875, 1.0,  // Middle
                    0.25, 0.25, 0.25, 0.75, 0.625, 0.75,  // Bottom
                    0.75, 0.25, 0.375, 1.0, 0.5, 0.625,  // Top
                    0.0, 0.6875, 0.0, 1.0, 1.0, 1.0 // 4 sides of hopper (top)
                    //0.0, 0.6875, 0.0, 1.0, 1.0, 0.125,
                    //0.0, 0.6875, 0.875, 1.0, 1.0, 1.0,
                    //0.0, 0.6875, 0.0, 0.125, 1.0, 1.0,
                ...
                BlockFace.DOWN -> return doubleArrayOf( // Standing inside
                    0.0, 0.625, 0.0, 1.0, 0.6875, 1.0,  // Middle
                    0.25, 0.25, 0.25, 0.75, 0.625, 0.75,  // Bottom
                    0.375, 0.0, 0.375, 0.625, 0.25, 0.625,  // Top
                    0.0, 0.6875, 0.0, 1.0, 1.0, 1.0 // 4 sides of hopper (top)
                    //0.0, 0.6875, 0.0, 1.0, 1.0, 0.125,
                    //0.0, 0.6875, 0.875, 1.0, 1.0, 1.0,
                    //0.0, 0.6875, 0.0, 0.125, 1.0, 1.0,
