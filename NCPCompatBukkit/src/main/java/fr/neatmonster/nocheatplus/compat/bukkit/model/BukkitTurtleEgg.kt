...
class BukkitTurtleEgg : BukkitShapeModel {
    override fun getShape(
        ...
        if (blockData is TurtleEgg) {
            when (blockData.eggs) {
                1 -> return doubleArrayOf(0.23, 0.0, 0.23, 0.75, 0.4375, 0.75)
                2, 3, 4 -> return doubleArrayOf(0.0625, 0.0, 0.0625, 0.9375, 0.4375, 0.9375)
                else -> {}
            }
        }
