...
class BukkitCauldron(minY: Double, sideWidth: Double, sideHeight: Double, coreHeight: Double) : BukkitShapeModel {
    private val bounds: DoubleArray

    init {
        bounds = doubleArrayOf( // Core
            sideWidth, minY, sideWidth, 1 - sideWidth, minY + coreHeight, 1 - sideWidth,  // 4 side
