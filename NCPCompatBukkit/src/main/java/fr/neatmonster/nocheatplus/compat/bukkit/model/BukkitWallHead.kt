...
class BukkitWallHead : BukkitShapeModel {
    override fun getShape(
        ...
        if (blockData is Directional) {
            ...
            when (face) {
                BlockFace.NORTH -> return doubleArrayOf(0.25, 0.25, 0.5, 0.75, 0.75, 1.0)
                BlockFace.SOUTH -> return doubleArrayOf(0.25, 0.25, 0.0, 0.75, 0.75, 0.5)
                BlockFace.WEST -> return doubleArrayOf(0.5, 0.25, 0.25, 1.0, 0.75, 0.75)
                BlockFace.EAST -> return doubleArrayOf(0.0, 0.25, 0.25, 0.5, 0.75, 0.75)
                else -> {}
            }
        }
