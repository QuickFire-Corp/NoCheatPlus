...
interface ShapeModel<W> {
    ...
    fun getShape(blockCache: BlockCache?, world: W, x: Int, y: Int, z: Int): DoubleArray?
     ...
     * for performance.
     */
    fun getFakeData(blockCache: BlockCache?, world: W, x: Int, y: Int, z: Int): Int
}