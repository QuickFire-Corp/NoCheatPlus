 ...
 * @author asofold
 */
class ReflectIBlockData(base: ReflectBase?, reflectMaterial: ReflectMaterial) {
    val nmsClass: Class<*>
    ...
    init {
        ...
        nmsGetMaterial = getMethodNoArgs(nmsClass, "getMaterial", reflectMaterial.nmsClass)
     ...
     * On failures.
     */
    fun nms_getMaterial(iBlockData: Any?): Any {
        return try {
            nmsGetMaterial!!.invoke(iBlockData)
