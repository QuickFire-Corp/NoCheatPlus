...
class ReflectMaterial(base: ReflectBase?) {
    val nmsClass: Class<*>
    val nmsIsLiquid: Method?
    val nmsIsSolid: Method?

    init {
        nmsClass = Class.forName(base!!.nmsPackageName + ".Material")
        nmsIsLiquid = getMethodNoArgs(nmsClass, "isLiquid", Boolean::class.javaPrimitiveType)
        nmsIsSolid = getMethodNoArgs(nmsClass, "isSolid", Boolean::class.javaPrimitiveType)
    }
}