...
class BukkitFetchableBounds : BukkitShapeModel {
    override fun getShape(blockCache: BlockCache?, world: World, x: Int, y: Int, z: Int): DoubleArray? {
        val block = world.getBlockAt(x, y, z)
        val blockshape = block.collisionShape
        var res = doubleArrayOf()
        for (box in blockshape.boundingBoxes) {
    ...
    private fun toArray(box: BoundingBox): DoubleArray {
        return doubleArrayOf(box.minX, box.minY, box.minZ, box.maxX, box.maxY, box.maxZ)
    }
