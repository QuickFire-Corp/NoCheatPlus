...
class BukkitStatic(vararg bounds: Double) : BukkitShapeModel {
     ...
     * @param height
     */
    constructor(height: Double) : this(0.0, height) {}
     ...
     * @param height
     */
    constructor(xzInset: Double, height: Double) : this(xzInset, 0.0, xzInset, 1.0 - xzInset, height, 1.0 - xzInset) {}
     ...
     */
    init {
        require(bounds.size % 6 == 0) { "The length must be a multiple of 6" }
        this.bounds = bounds
    }
