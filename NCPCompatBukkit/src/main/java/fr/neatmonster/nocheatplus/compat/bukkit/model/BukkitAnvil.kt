...
class BukkitAnvil : BukkitShapeModel {
    override fun getShape(
        ...
        if (blockData is Directional) {
            ...
            when (face) {
                BlockFace.NORTH, BlockFace.SOUTH -> return doubleArrayOf( // Bottom
                    0.125, 0.0, 0.125, 0.875, 0.25, 0.875,  // Top
                    0.1875, 0.625, 0.0, 0.8125, 1.0, 1.0 // Body... maybe not need
                )
                BlockFace.WEST, BlockFace.EAST -> return doubleArrayOf( // Bottom
                    0.125, 0.0, 0.125, 0.875, 0.25, 0.875,  // Top
                    0.0, 0.625, 0.1875, 1.0, 1.0, 0.8125 // Body... maybe not need
                )
                else -> {}
            }
        }
